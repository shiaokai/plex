...
char_train_dir = '/data/text/plex/synth/train/char'
...
img_char_train_gt_dir = '/data/text/plex/icdar/train/charAnn'
img_char_test_gt_dir = '/data/text/plex/icdar/test/charAnn'
...
bootstrap_bg_dir = '/data/text/plex/synthBt_py/train/charBg'

max_per_class = 1000
max_bg = 10000
max_bg_after_bs = 20000
